...
public class FuncionarioServiceImpl implements FuncionarioService {
	...
	public void popularTabelaInicial() {
		repositorio.saveAll(List.of(
				new Funcionario(null, "João","Joaçaba", 2, new BigDecimal("2000.00"), LocalDate.of(1998, 07, 9)),	
				new Funcionario(null, "Marcos","Videira", 4, new BigDecimal("3000.57"), LocalDate.of(1994, 10, 30)),	
				new Funcionario(null, "Maria","São Miguel do Oeste", 1, new BigDecimal("2500"), LocalDate.of(1988, 11, 20)),	
				new Funcionario(null, "Marcelo","Chapecó", 0, new BigDecimal("1000"), LocalDate.of(1978, 01, 16)),	
				new Funcionario(null, "Ana","Luzerna", 2, new BigDecimal("7000"), LocalDate.of(1974, 03, 12)),	
				new Funcionario(null, "Amanda","Ibicaré", 3, new BigDecimal("4000"), LocalDate.of(1991, 04, 17)),	
				new Funcionario(null, "Larissa","Acre", 1, new BigDecimal("2000"), LocalDate.of(1981, 9, 03)),	
				new Funcionario(null, "Bruna","Roraima", 1, new BigDecimal("1700"), LocalDate.of(2002, 01, 14)),	
				new Funcionario(null, "Eduardo","Água Doce", 0, new BigDecimal("2800"), LocalDate.of(1994, 07, 21)),	
				new Funcionario(null, "Lucas","Bangladesh", 0, new BigDecimal("2700"), LocalDate.of(1995, 12, 27)),	
				new Funcionario(null, "Natalia","Rio de Janeiro", 2, new BigDecimal("4200"), LocalDate.of(1996, 11, 02))	
			)
		);
	}
